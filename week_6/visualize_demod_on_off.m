function visualize_demod_on_off(H_estimate,N,fs,imageData, imageSize, bitsPerPixel,colorMap,Ld,Lt,cp,rxBitStream,Nq,index)
...
H_estimate_half = zeros(N/2+1,size( H_estimate,2));
H_estimate_half(index,:) = H_estimate(index,:);
f = fs*(0:(N/2))/N;
